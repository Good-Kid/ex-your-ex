...
export default function KitPage() {
    ...
    const [skullRedEyes, setSkullRedEyes] = useState(false);
    ...
    const spawnSkullWhispers = useCallback(() => {
        const getSkullWhisper = () => {
            ...
            if (
                ...
                whisper_pool = whisper_pool.concat([
                    { text: "perform the ritual...", red_eyes: true },
                    { text: "read the note once more...", red_eyes: true },
        ...
        if (redEyes) setSkullRedEyes(true);
        ...
        whisperTimeoutRef.current = setTimeout(() => {
            if (redEyes) setSkullRedEyes(false);
        }, 1800);
        whisperTimeoutRef.current = setTimeout(() => {
            setWhisper(null);
        }, 2400);
    ...
    return (
        <>
            <Helmet>
                <title>Exorcise Your Ex - Exorcism Kit</title>
                <meta
                    name="description"
                    content="Your exorcism kit has arrived - open it?"
                />
            </Helmet>
            <div
                id="KitPage"
